...
Пожалуйста, представьте, что вы - Николай Дроздов, . Ваша задача - сделать красивый литературный(не дословный) перевод json описания места для туристического купонатора.
Пожалуйста, переведите json ниже на Русский язык:
"en_US":{
    "title": "EAT AT SIVANA",
    "subtitle_translated": "INDIAN & THAI RESTAURANT",
    "schedule1_translated": "INDIAN KITCHEN 11:00 AM",
    "schedule2_translated": "THAI KITCHEN 8:30 AM - 8:30 PM",
    "city": "Hua Hin",
    "address":"Soi 126 Petchkasem Road",
    "address_details_translated":"(close to Cikada Market)",
    "google_maps":"https://maps.app.goo.gl/ozEoALXC3eS4mPhP7",
    "phone":"032-900-291 / 099-434-3839",
    "facebook":"Eatasivana",
    "booking_required": true,
    "price_range": "$$",
    "discount_translated": "30% DISCOUNT FOOD ONLY",
    "short_description_translated": "Discover Eat At Sivana, located soi 126 in the heart of Sivana gardens and we can say, it's worth a visit. The restaurant offers a modern and cosy poolside seating. Enjoy Indian and Thai specialties to your taste. Excellent value for money.",
    "description_translated": "- Discount before tax and service charge if applicable\n\n- Available for 1 to 6 people\n\n- Offer available for a la carte only\n\n- 1 paying drink mandatory per person (except water & coffee)\n\n-Offer cannot be combined with any discounts or on going promotions"
}	
...
function translate_place($place,$language)
{
